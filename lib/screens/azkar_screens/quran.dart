      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            zekr(
              text1: '',
              text2: 'رَبَّنَا لاَ تَجْعَلْنَا مَعَ الْقَوْمِ الظَّالِمِينَ',
              text3: ' [الأعراف - 47]',
              times: 1,
              context: context,
            ),
            ...
            zekr(
              text1: '',
              text2: 'رَبِّ لَا تَذَرْنِي فَرْدًا وَأَنتَ خَيْرُ الْوَارِثِينَ',
              text3: '[الأنبياء - 89]',
              times: 1,
              context: context,
            ),
            ...
            zekr(
              text1: '',
              text2: 'رَّبِّ اغْفِرْ وَارْحَمْ وَأَنتَ خَيْرُ الرَّاحِمِينَ',
              text3: '[المؤمنون - 118]',
              times: 1,
              context: context,
            ),
